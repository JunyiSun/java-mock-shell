...
/**
 * An exception thrown whenever a file or folder with an identical name is added
 * to the Folder object.
 */

public class IdenticalNameException extends Exception {
